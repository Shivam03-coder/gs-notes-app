  ...
  return (
    <section className="col-span-full space-y-8 py-5">
      ...
      <SectionHeader
        ...
        icons={<LeafIcon size={32} />}
        subtitle="Our legal management tool is designed to simplify and streamline your operations, helping you save time and resources. From organizing legal documents to managing client relationships."
      />
